...
import fr.insy2s.AppTestApp;

import fr.insy2s.config.Constants;
import fr.insy2s.config.audit.AuditEventConverter;
import fr.insy2s.domain.PersistentAuditEvent;
...
import static fr.insy2s.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
